...
def dibujarDerrota():
    ...
    #GAME OVER
    ganaOPierde=Rotulo("¡¡GAME OVER!!", 270,60, relleno=gradiente('rojoNaranja','rojo', 'rojoOscuro'), tamaño=30, fuente="monospace",negrito=True)
    #FUEGO
    Fuego = Polígono(213, 150, 245, 160, 292, 158, 275, 170, 250, 167, 270, 190, 295, 190, 280, 200, 240, 193, 250, 215, 267, 223, 244, 220, 237, 205, 220, 220, 227, 180,
    relleno=gradiente('blanco', 'naranja', 'rojoNaranja', inicio='izquierda'),opacidad=80)
