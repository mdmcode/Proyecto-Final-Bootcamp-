...
def dibujarBatalla():
    global rPregunta
    fondo = Rect(0, 0, 400, 400, relleno=gradient('índigo', 'azulPizarraOscuro', 'azulMedianoche', inicio='inferior'))
    ...
    Label("Pregunta", 80, 305, relleno='grisPizarraOscuro', tamaño=20)

    # Rotulo de pregunta
    rPregunta = Label('', 80, 340, tamaño=15, negrito=True)

    for i in range(3):
        opciones.agregar(
            Label('', 280, 305 + 30 * i, tamaño=15, negrito=True)
        )
